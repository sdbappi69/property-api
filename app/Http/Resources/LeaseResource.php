...
class LeaseResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'meter_readings' => $this->meter_readings->count() ? $this->meter_readings : [],
            ...
            'special_rent_amount' => $this->special_rent_amount,
            'rent_deposit' => $this->rent_deposit,
            'deposit_deduction_percentage' => $this->deposit_deduction_percentage,
